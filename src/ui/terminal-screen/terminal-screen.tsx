...
const shell =
  'relative z-10 transform-gpu flex h-full min-h-0 w-full flex-col overflow-hidden border-terminal-faint/30 bg-terminal-bg/80 wide:max-h-[880px] wide:max-w-[1280px] wide:rounded-lg wide:border'
