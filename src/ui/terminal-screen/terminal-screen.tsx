...
const shell =
  'relative z-10 flex h-full min-h-0 w-full flex-col overflow-hidden border-terminal-faint/30 bg-terminal-bg wide:max-h-[880px] wide:max-w-[1280px] wide:rounded-lg wide:border wide:shadow-[0_24px_80px_-12px_rgb(0_0_0/0.9)]'
